...
def get_minibatch(lines, tok2id, index, batch_size, max_len, sort=False, idx=None, dist_measurer=None, sample_rate=0.0):
    """
    :param lines: sentences
    :param tok2id: token to id
    :param index: index of the batch size
    :param batch_size:
    :param max_len:
    :param sort:
    :param idx:
    ...
    lines: list = [['<s>'] + line[:max_len] + ['</s>'] for line in lines[index:index + batch_size]]
